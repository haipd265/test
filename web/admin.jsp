...
<html lang="en">
    ...
    <body>
        <c:set var="size" value="${sessionScope.size}"></c:set>
            ...
            <c:if test="${sessionScope.nick==null}">
                <div class="login" style="width: 12%;margin-left: 4%;margin-right: 4%;text-align: center"><a href="login.jsp">Login</a></div>
            </c:if>
        </div>
...
<!--        <div class="search">
        ...
        <h3 class="title" style="text-align: center;font-weight: 700">Management</h3>

        <div class="foradmin" style="text-align: center">
            <div style="margin:20px 0"><u><a style="font-size: 24px;text-decoration: none" href="topproduct">Top 5 sản phẩm bán chạy nhất trong tháng</a></u></div>
            <div style="margin:20px 0"><u><a style="font-size: 24px;text-decoration: none" href="listorder">Danh sách order khách hàng</a></u></div>
            <div style="margin:20px 0"><u><a style="font-size: 24px;text-decoration: none" href="insert">Thêm sản phẩm mới</a></u></div>
        </div>
        <hr>
