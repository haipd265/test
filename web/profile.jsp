...
<html lang="en">
    ...
    <body>
        ...
        <h3 class="title" style="text-align: center;font-weight: 700">Thông tin tài khoản</h3>

        <div class="profile">
            <c:set var="user" value="${requestScope.userProfile}"></c:set>
            <div class="p_left" style="border: 2px solid black">
                    <div class="inside">
                        <h2>${user.logo}</h2>
                </div>
            </div>
            <div class="p_right">
                ...
                <h2>Address: ${user.address}</h3>
                <h5>Email: ${user.email}</h5>
                <h5>Phone Number: ${user.phone}</h5>
            </div>
            <div class="chinhsua" style="text-align: center">
                <a href="editProfile?user=${user.username}">
                    <ion-icon style="font-size: 36px;"  name="settings-outline"></ion-icon>
                </a>
            </div>
        </div>
        <hr>
