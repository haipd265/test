                ...
                <div class="detailProduct">
                    ...
                    <c:if test="${requestScope.mess==null}">
                        ...
                        <div>
                            ...
                            <form action="editMilk" method="post">
                                <table border="1px">
                                    <tr>
                                        <td class="left">ID</td>
                                        <td><input type="text" name="idProduct" readonly value="${sp.id}"></td>
                                    </tr>
                                    <tr>
                                        <td class="left">Tên sản phẩm</td>
                                        <td><input type="text" name="nameProduct" readonly value="${sp.name}"></td>
                                    </tr>
                                    <tr>
                                        <td class="left">Quantity Exist</td>
                                        <td><input type="text" name="quantity" value="${sp.quantity}" required></td>
                                    </tr>
                                    <tr>
                                        ...
                                        %>
                                                        <td><input type="text" name="price" value="${sp.price}"></td>
                                        <!--<td><input type="text" name="price" value="<%=realprice%> đồng"></td>-->
                                    </tr>
                                    <tr>
                                        <td class="left">Describe</td>
                                        <td><input type="text" name="describe"  value="${sp.describe}"></td>
                                    </tr>
                                    <tr>
                                        <td class="left">Ngày sản xuất</td>
                                        <td><input type="date" name="published" value="${sp.published}"></td>
                                    </tr>
                                    <tr>
                                        <td class="left">TypeMilk</td>
                                        <td><input type="text" name="typeid"  value="${sp.typeID}" ></td>
                                    </tr>
                                    <tr>
                                        <td class="left">Link Img</td>
                                        <td><input type="text" name="img"  value="${sp.img}"></td>
                                    </tr>

                                </table>
                                <div class="hoanthanh">
                                    <h2>Choose New Type</h2>
