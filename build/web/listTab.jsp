...
<html lang="en">
    ...
    <body>
        ...
        <div class="contain">
            <div class="option">
                <c:set var="p" value="${sessionScope.idtab}"></c:set>
                    <form>
                        <ul>
                        <c:forEach items="${requestScope.listType}" var="ctype">
                            <li class="${ctype.typeid==p?"active":""}"><a  href="tab?id=${ctype.typeid}">${ctype.nameType}</a></li>
                            </c:forEach> 
                    </ul>
                </form>
            </div>
            ...
            <div class="right">
                ...
                <c:set var="num" value="${sessionScope.num}"></c:set>
                    ...
                    <c:forEach begin="${1}" end="${sessionScope.num}" var="i">
                        <a class="${i==page?"active":""}" href="tab?page=${i}&id=${p}">${i}</a>
                    </c:forEach>
                </div>
                <!-- div right -->
                <c:if test="${sessionScope.nick.role==1}">
