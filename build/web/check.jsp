...
<html lang="en">
    ...
    <body>
        ...
        <h3 class="title" style="text-align: center;font-weight: 700">Top 5 sản phẩm bán chạy nhất trong tháng</h3>
        ...
        <table style="margin: 20px auto;text-align: center">
            <tr>
                ...
                <th style="width: 10%">TypeID</th>
                <th style="width: 10%">Số lượng đã bán</th>
            </tr>
            <c:forEach items="${requestScope.list}" var="list">
                <tr style="width: 80%">
                    <td style="width: 25%">${list.id}</td>
                    <td style="width: 35%">${list.name}</td>
                    <td style="width: 10%">${list.price}</td>
                    <td style="width: 10%"><img src="${list.img}" style="height: 50px;width: 50px"></td>
                    <td style="width: 10%">${list.typeID}</td>
                    <td style="width: 10%">${list.quantity}</td>
                </tr>
            </c:forEach>
        </table>
