...
<html lang="en">
    ...
    <body>
        ...
        <h3 class="title" style="text-align: center;font-weight: 700">Thông tin order</h3>
            ...
            <c:forEach items="${sessionScope.data}" var="i">
                <c:set var="start" value="${start+1}"></c:set>
                    ...
                    <td style="width: 30%">
                        ...
                        <div><a href="detail?idProduct=${i.product.id}"><img src="${i.product.img}" style="height: 50px;width: 50px"></a></div>
                    </td>
                    <td style="width: 10%">${i.quantity}</td>
        ...
        <c:set var="num" value="${sessionScope.num}"></c:set>
            ...
            <c:forEach begin="${1}" end="${sessionScope.num}" var="ip">
                <a class="${ip==page?"active":""}" href="infoorder?page=${ip}&id=${sessionScope.info}">${ip}</a>
            </c:forEach>
        </div>
        <hr>
