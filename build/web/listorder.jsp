...
<html lang="en">
    ...
    <body>
        ...
        <div style="display: flex;">
            <div style="width: 80%;padding:0 5%;border-right:2px solid bisque">
            ...
            <div style="width: 20%;padding:0 2%;border: 2px solid lavender;">
                <div style="font-style: italic;font-size: 16px;font-weight: 700">Doanh thu cửa hàng</div>
                <div>Đã bán được: <fm:formatNumber pattern="##.#" value="${requestScope.sum}"></fm:formatNumber> đồng</div>
                <div>Lãi: <fm:formatNumber pattern="##.#" value="${requestScope.price}"></fm:formatNumber> đồng</div>
                </div>
            </div>
