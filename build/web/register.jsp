            ...
            <div class="right">
                ...
                <form action="register" method="post" style="margin-top:20px;">
                    <table>
                        ...
                        <tr>
                            <td class="hien" >Password</td>
                            <td><input name="password" type="password" required></td>
                        </tr> 
                        <tr>
                            <td class="hien" >Re-Password</td>
                            <td><input name="re-password" type="password" required></td>
                        </tr> 
                        <tr>
                            <td class="hien" >Address</td>
                            <td><input  name="address" type="text" required></td>
                        </tr>
                        <tr>
                            <td class="hien" >Email</td>
                            <td><input name="email" type="text" required></td>
                        </tr>
                        <tr>
                            <td class="hien" >Phone</td>
                            <td><input name="phone" type="text" required></td>
                        </tr>
                        <tr>
                            <td class="hien" >Logo(Show when you login)</td>
                            <td><input  name="logo" type="text" required></td>
                        </tr>
                    </table>
                    <br/>
                    <div style="text-align: center;margin-bottom: 20px;">
                    <input style="width: 30%;border: 2px solid red;height: 40px;border-radius: 5px" type="submit" value="Register">
                    </div>
                    <c:if test="${requestScope.er!=null}">
                        <h5>${requestScope.er}</h5>
                    </c:if>                 
                </form>
            </div>
        </div>
