...
<html lang="en">
    ...
    <body>
        ...
        <div class="search">
            ...
            <h3 class="title" style="text-align: center;font-weight: 700">Cập nhập thông tin tài khoản</h3>
            <div style="text-align: center; background-color: red;padding:10px 0;margin:0 20%;">
                <a style="color:white;text-decoration: none" href="changepass">Đổi mật khẩu</a>
            </div>
            ...
            <div class="profileEdit">
                <c:set var="user" value="${requestScope.userProfile}"></c:set>
                    ...
                    <table>
                        <tr>
                            <td>Username</td>
                            <td><input name="username" readonly value="${user.username}"></td>
                    </tr>
                    <tr>
                        <td>Address</td>
                    ...
                    <tr>
                        <td>Logo</td>
                        <td><input name="logo" value="${user.logo}"></td>
                    </tr>
                </table>
                    <div style="margin:20px 0;"><input type="submit" value="Save"></div>
            </div>
